...
ButtonGrassTapir.addEventListener("click", function () {
  container.innerHTML = "";
  const grassTapirs = tapirs.filter(
    (tapir) => tapir.category === "grass tapir"
  );
...
ButtonWaterTapir.addEventListener("click", function () {
  container.innerHTML = "";
  const waterTapirs = tapirs.filter(
    (tapir) => tapir.category === "water tapir"
  );
...
function addToCart() {
  ...
  btnArray.forEach((btn) =>
    btn.dEventListener("click", function (event) {
